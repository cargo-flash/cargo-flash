...
>(({ className, children, variant = 'default', ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            "flex h-10 w-full items-center justify-between rounded-lg border px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
            variant === 'default' && "border-input bg-background",
            variant === 'matrix' && [
                "border-[#00ff41]/30 bg-[#0d1117] text-[#00ff41] font-mono",
    ...
    <SelectPrimitive.Portal>
        <SelectPrimitive.Content
            ...
            className={cn(
                ...
                variant === 'matrix' && "bg-[#0d1117] border-[#00ff41]/30 text-[#00ff41]",
                position === "popper" &&
...
>(({ className, children, variant = 'default', ...props }, ref) => (
    <SelectPrimitive.Item
        ...
        className={cn(
            ...
            variant === 'matrix' && "focus:bg-[#00ff41]/10 focus:text-[#00ff41]",
            className
        )}
        {...props}
    >
